...
425, ((__turbopack_context__, module, exports) => {
"use strict";
...
640, ((__turbopack_context__, module, exports) => {
"use strict";

if ("TURBOPACK compile-time truthy", 1) {
    module.exports = __turbopack_context__.r(425);
...
// MERGED MODULE: [project]/packages/x-sdk/src/index.ts [library-client] (ecmascript)
;
// MERGED MODULE: [project]/packages/x-sdk/src/index.ts [library-client] (ecmascript) <locals>
;
;
;
;
;
;
__turbopack_context__.s([], 501);
var __TURBOPACK__imported__module__501__ = __turbopack_context__.i(501);
// MERGED MODULE: [project]/packages/x-sdk/src/chat-providers/index.ts [library-client] (ecmascript)
;
// MERGED MODULE: [project]/packages/x-sdk/src/chat-providers/index.ts [library-client] (ecmascript) <locals>
;
;
;
;
;
__turbopack_context__.s([], 36);
var __TURBOPACK__imported__module__36__ = __turbopack_context__.i(36);
// MERGED MODULE: [project]/packages/x-sdk/src/chat-providers/AbstractChatProvider.ts [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/packages/x-sdk/src/chat-providers/DeepSeekChatProvider.ts [library-client] (ecmascript)
;
;
;
;
...
// MERGED MODULE: [project]/packages/x-sdk/src/chat-providers/DefaultChatProvider.ts [library-client] (ecmascript)
;
;
;
...
// MERGED MODULE: [project]/packages/x-sdk/src/chat-providers/OpenAIChatProvider.ts [library-client] (ecmascript)
;
;
;
;
...
var __TURBOPACK__imported__module__732__ = __turbopack_context__.i(732);
// MERGED MODULE: [project]/packages/x-sdk/src/x-chat/index.ts [library-client] (ecmascript)
;
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/index.js [library-client] (ecmascript) <locals>
;
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useEvent.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useMergedState.js [library-client] (ecmascript)
;
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useLayoutEffect.js [library-client] (ecmascript)
;
var __TURBOPACK__imported__module__571__1 = __TURBOPACK__imported__module__571__;
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/Dom/canUseDom.js [library-client] (ecmascript)
;
function canUseDom() {
 ...
 */ const useInternalLayoutEffect = ("TURBOPACK compile-time value", "production") !== 'test' && canUseDom() ? __TURBOPACK__imported__module__571__1["useLayoutEffect"] : __TURBOPACK__imported__module__571__1["useEffect"];
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useState.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useControlledState.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/ref.js [library-client] (ecmascript)
;
var __TURBOPACK__imported__module__571__4 = __TURBOPACK__imported__module__571__;
var __TURBOPACK__imported__module__640__ = __turbopack_context__.i(640);
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useMemo.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/React/isFragment.js [library-client] (ecmascript)
;
...
const supportRef = (nodeOrComponent)=>{
    ...
    const type = (0, __TURBOPACK__imported__module__640__["isMemo"])(nodeOrComponent) ? nodeOrComponent.type.type : nodeOrComponent.type;
    // Function component node
    if (typeof type === 'function' && !type.prototype?.render && type.$$typeof !== __TURBOPACK__imported__module__640__["ForwardRef"]) {
        return false;
    }
    // Class component
    if (typeof nodeOrComponent === 'function' && !nodeOrComponent.prototype?.render && nodeOrComponent.$$typeof !== __TURBOPACK__imported__module__640__["ForwardRef"]) {
        return false;
    }
    return true;
};
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/utils/get.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/utils/set.js [library-client] (ecmascript)
;
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/warning.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/omit.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/Children/toArray.js [library-client] (ecmascript)
;
...
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/mergeProps.js [library-client] (ecmascript)
;
/**
...
var __TURBOPACK__default__export__4 = mergeProps;
;
;
;
;
...
;
;
// MERGED MODULE: [project]/node_modules/@rc-component/util/es/hooks/useEvent.js [library-client] (ecmascript) <export default as useEvent>
;
var __TURBOPACK__imported__module__571__7 = __TURBOPACK__imported__module__571__;
// MERGED MODULE: [project]/packages/x-sdk/src/x-chat/store.ts [library-client] (ecmascript)
;
...
function useXChat(config) {
    ...
    // 消息队列：存储会话切换后的待发送消息
    const messageQueueRef = __TURBOPACK__imported__module__571__7["default"].useRef(new Map());
    ...
    // 会话切换完成后处理消息队列
    const processMessageQueue = __TURBOPACK__imported__module__571__7["default"].useCallback(()=>{
...
// MERGED MODULE: [project]/packages/x-sdk/src/x-conversations/index.ts [library-client] (ecmascript)
;
var __TURBOPACK__imported__module__571__9 = __TURBOPACK__imported__module__571__;
// MERGED MODULE: [project]/packages/x-sdk/src/x-conversations/store.ts [library-client] (ecmascript)
;
;
...
// MERGED MODULE: [project]/packages/x-sdk/src/x-request/index.ts [library-client] (ecmascript)
;
// MERGED MODULE: [project]/packages/x-sdk/src/x-stream/index.ts [library-client] (ecmascript)
;
/**
...
var __TURBOPACK__default__export__5 = XStream;
// MERGED MODULE: [project]/packages/x-sdk/src/x-request/x-fetch.ts [library-client] (ecmascript)
;
;
...
var __TURBOPACK__default__export__6 = XFetch;
;
;
;
/**
...
class XRequestClass extends AbstractXRequestClass {
    ...
    init(extraParams, extraHeaders) {
        ...
        this._asyncHandler = __TURBOPACK__default__export__6(this.baseURL, {
            fetch,
            ...requestInit
        }).then(async (response)=>{
            clearTimeout(this.timeoutHandler);
    ...
    customResponseHandler = async (response, callbacks, transformStream, streamTimeout, streamSeparator, partSeparator, kvSeparator)=>{
        const stream = __TURBOPACK__default__export__5({
...
var __TURBOPACK__default__export__7 = XRequest;
__turbopack_context__.s([
    "AbstractChatProvider",
    ()=>AbstractChatProvider,
...
["x-sdk.js", {"otherChunks":[],"runtimeModuleIds":[596]}],
]);
